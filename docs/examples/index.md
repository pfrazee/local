...
// instantiate apps
Environment.addServer('intro.doc', new Environment.WorkerServer({
	scriptUrl: '/local/apps/doc/intro.js'
}));
Environment.addServer('features.doc', new Environment.WorkerServer({
	scriptUrl: '/local/apps/doc/features.js'
}));
Environment.addServer('request-log.util', new Environment.WorkerServer({
	scriptUrl: '/local/apps/util/log.js',
	title: 'request log'
}));
