define(['./jsoneditoronline/jsoneditor'], function() {
    ...
    Module.prototype.editor = function(request) {
        ...
        // Give interface
        return { code:200, body:'<h3>JSON Editor Online <small>by Jos de Jong (<a href="https://github.com/wjosdejong/jsoneditoronline" title="github repo">https://github.com/wjosdejong/jsoneditoronline</a>)</small></h3><div id="jsoneditor"></div><style>div.jsoneditor-frame { border:none } td.jsoneditor-menu { background:none; border:none }</style>', 'content-type':'text/html' };
    };
