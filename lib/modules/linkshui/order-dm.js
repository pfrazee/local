define(function() {
    ...
    var DivResource = {
        ...
        GET:'Provides the data in the div. If a control uri is specific, will pipe the request to it. Otherwise, gives the div innerHTML',
    ...
    var __createDivFromRequest = function(index, request) {
        ...
        var html = [
            ...
            '</div>',
            '<div id="', elem_id + '-body','" class="orderdiv-body">', request.body.toHtml(), '</div>',
