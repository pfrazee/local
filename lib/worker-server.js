...
// a few conveniences
var console = {};
console.log = localApp.log;// promises
// ========
// pfraze 2013
	...
	function execCallback(parentPromise, targetPromise, fn) {
		if (fn === null) {
			...
			try { newValue = fn(parentPromise.value); }
				...
				if (console.error) console.error("Promise exception thrown", e);
				else if (e.stack) console.error("Promise exception thrown", e.message, '::', e.stack);
				else console.log("Promise exception thrown", e.toString(), '::', e);
