...
var makeNavLi = function(a, b, label) {
	return [
		...
		'<a href="httpl://'+local.config.domain, '/', b, '">', label, '</a></li>'
	].join('');
};
	...
	switch (tab) {
		...
		default:
			html = [
				...
				'<form action="httpl://', local.config.domain, '/httpl" method="post" class="form-horizontal">',
					'<legend>',
						'Local ',
						isPost ? 'Response <small>from ' : 'Form <small>targets ',
						'httpl://', local.config.domain, '</small>',
					'</legend>',
					...
					makeFormItem('', isPost ?
						'<a class="btn" href="httpl://'+local.config.domain+'/httpl">Reset</a>' :
		...
		case 'app':
			html = [
				...
				'<form action="httpl://', local.config.domain, '/list" onkeyup="patch">',
		...
		case 'env':
			html = [
				...
				'<form action="httpl://', local.config.domain, '/env" method="post" class="form-horizontal">',
